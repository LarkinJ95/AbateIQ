...
export default function DocumentsPage() {
  ...
  const handleViewSummary = (doc: Document) => {
    if (doc.summary) {
        setSummaryResult(doc.summary);
        setSelectedDocForSummary(doc);
        setIsSummaryDialogOpen(true);
    } else {
        toast({ title: "No Summary Available", description: "This document has not been summarized yet."});
    }
  }
                ...
                <CardFooter className="flex justify-between items-center p-4 pt-0">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onSelect={() => handleViewSummary(doc)} disabled={!doc.summary}>
       ...
       <Dialog open={isSummaryDialogOpen} onOpenChange={setIsSummaryDialogOpen}>
            <DialogContent className="max-w-2xl">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        This summary for {selectedDocForSummary?.name} was generated by AI. Always verify critical information against the original document.
                    </DialogDescription>
                </DialogHeader>
